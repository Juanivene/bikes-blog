    ...
    <Grid container className="px-8" gap={4}>
      <Grid item className="flex items-center justify-center pt-16" xs={12}>
        <Grid container className={bangers.className} gap={4}>
          <Grid item xs={12}>
            <h2 className="text-center text-3xl font-bold text-white sm:text-4xl md:text-5xl lg:text-7xl">
              La moto que buscas, está aquí.
            </h2>
          </Grid>
          <Grid item className="flex items-center justify-center" xs={12}>
            <h3 className="text-center text-lg text-white sm:text-xl md:text-3xl">
      ...
      <Grid
        ...
        xs={12}
      >
        <span className="mt-2 rounded-full bg-yellow-suave px-2 py-1 text-sm font-semibold text-gray-900 sm:mt-0 sm:px-6 sm:py-1 md:text-lg">
          FÁCIL Y RÁPIDO
        </span>
        <span className="mt-2 rounded-full bg-yellow-suave px-2 py-1 text-sm font-semibold text-gray-900 sm:mt-0 sm:px-6 sm:py-1 md:text-lg">
          100% GRATUITO
